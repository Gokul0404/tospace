          ...
          <div className="bg-white w-screen  pt-[11.5vh] ">
            ...
            <div>
              <div className="flex flex-col justify-center items-center text-white py-[10vh]">
                <h2 className="text-fblue   fontbold">
                  COURSE
                </h2>
                <p className="mobile-sm:text-justify tablet:text-center w-[80vw] parafont ">
                  ...
                  arbitrary values if you need to deviate from your design
                  tokens arbitrary values if you need to deviate from your
                  design tokens.
                </p>
              </div>
                      ...
                      <div className="laptop:basis-1/4 py-10 px-5 relative flex justify-center">
                        ...
                        >
                          ...
                          <di className=" !flex  !justify-center !items-center gap-x-5">
                            <div className="mobile-sm:py-5 tablet:pt-5 laptop:pb-5 ">
