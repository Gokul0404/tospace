  ...
  return (
    <>
      <div className="video_part_section videobg   parafont mobile-sm:flex mobile-sm:justify-center mobile-sm:items-center mobile-sm:flex-col ">
        <div className="  video-side  4k-first:w-[75%] ">
          <div
            data-aos="fade-up"
            data-aos-anchor-placement="top-bottom"
            data-aos-duration="3000"
            className="vide0_session mobile-sm:flex mobile-sm:flex-col mobile-sm:justify-center mobile-sm:items-center laptop:flex-none laptop:grid laptop:grid-cols-2 gap-4 mobile-sm:w-[100%]  pb-10"
          >
            <div className="content-side mobile-sm:flex mobile-sm:flex-col mobile-sm:justify-center mobile-sm:items-center laptop:items-start laptop:flex laptop:justify-start items-start laptop:ml-[10vh] desktop:mr-[20vh] 4k-first:mx-[vh]  videobg z-10 laptop:pt-20 w-[85%] text-justify">
            ...
            <div className="pt-[10%] mobile-sm:px-10 ">
              <motion.video
                ...
                muted
                loop
                className="laptop:w-[80%]  mobile-sm:w-[200vw] tablet:w-[60vw] 4k-first:w-[60%] outline outline-offset-1 ring-[10px] ring-black outline-black"
                // initial={{ opacity: 0 }}
                // animate={{ }}
